...
2. Activate the virtual environment: Open the terminal, navigate to the folder where the folder 'donutshop' is saved (i.e. if saved in "./Desktop/myproject/", type in the command "cd './myproject'"), and type in "source donutshop/bin/activate".
