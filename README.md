...
2. Activate the virtual environment: Open the terminal, navigate to the parent folder containing 'fn_donutshop' (i.e. if saved in "./Desktop/myproject/", type in the command "cd './myproject'"), and...
    ...
    - Windows: ... type in "python3 -m venv donutshop_env" then "venv/Scripts/Activate.ps1".
3. Install required modules: type in "python3 -m pip install -r requirements.txt".
3. Run server: Navigate to "./fn_donutshop/donut_shop_website" and type in "python3 manage.py runserver".
